/// SPDY/3.1 header compression preset dictionary.
/// Source: https://github.com/moby/spdystream/blob/master/spdy/dictionary.go
/// Adler-32: 0xe3c6a7c2 (3821447106), length: 1423 bytes
pub const SPDY_DICT: &[u8] = &[
